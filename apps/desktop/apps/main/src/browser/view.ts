...
import type {
  ...
  BrowserState,
  BrowserTabState,
} from '@crewm8/shared/dist/browser-control.js';
...
export const BROWSER_PARTITION = 'persist:crewm8-browser';
...
export class BrowserViewManager extends EventEmitter {
  ...
  private wireEvents(tab: BrowserTab): void {
    ...
    // Intercept crewm8:// protocol URLs for internal actions (e.g. md-edit)
    wc.on('will-navigate', (event, url) => {
      if (url.startsWith('crewm8://')) {
