...
import { ipc } from '@crewm8/shared';
import path from 'node:path';
import os from 'node:os';
import { watcher as watcherCore, workspace } from '@crewm8/core';
import { workspace as workspaceShared } from '@crewm8/shared';
import * as mcpCore from '@crewm8/core/dist/mcp/mcp.js';
import * as runsCore from '@crewm8/core/dist/runs/runs.js';
import { bus } from '@crewm8/core/dist/runs/bus.js';
import { serviceBus } from '@crewm8/core/dist/services/service_bus.js';
...
import { RunEvent } from '@crewm8/shared/dist/runs.js';
import { ServiceEvent } from '@crewm8/shared/dist/service-events.js';
import container from '@crewm8/core/dist/di/container.js';
import { listOnboardingModels } from '@crewm8/core/dist/models/models-dev.js';
import { testModelConnection } from '@crewm8/core/dist/models/models.js';
import type { IModelConfigRepo } from '@crewm8/core/dist/models/repo.js';
import { IGranolaConfigRepo } from '@crewm8/core/dist/knowledge/granola/repo.js';
import { triggerSync as triggerGranolaSync } from '@crewm8/core/dist/knowledge/granola/sync.js';
import { ISlackConfigRepo } from '@crewm8/core/dist/slack/repo.js';
import { isOnboardingComplete, markOnboardingComplete } from '@crewm8/core/dist/config/note_creation_config.js';
import * as composioHandler from './composio-handler.js';
import { IAgentScheduleRepo } from '@crewm8/core/dist/agent-schedule/repo.js';
import { IAgentScheduleStateRepo } from '@crewm8/core/dist/agent-schedule/state-repo.js';
import { triggerRun as triggerAgentScheduleRun } from '@crewm8/core/dist/agent-schedule/runner.js';
import { search } from '@crewm8/core/dist/search/search.js';
import { versionHistory } from '@crewm8/core';
import { classifySchedule, processCrewInstruction } from '@crewm8/core/dist/knowledge/inline_tasks.js';
import { summarizeMeeting } from '@crewm8/core/dist/knowledge/summarize_meeting.js';
import { triggerTrackUpdate } from '@crewm8/core/dist/knowledge/track/runner.js';
import { trackBus } from '@crewm8/core/dist/knowledge/track/bus.js';
import {
  fetchYaml,
  updateTrackBlock,
  replaceTrackBlockYaml,
  deleteTrackBlock,
} from '@crewm8/core/dist/knowledge/track/fileops.js';
...
export function setupIpcHandlers() {
  ...
  registerIpcHandlers({
    ...
    'supermemory:is-configured': async () => {
      const { isConfigured } = await import('@crewm8/core/dist/supermemory/client.js');
      return { configured: await isConfigured() };
    },
    'supermemory:set-api-key': async (_event, args) => {
      try {
        const { setApiKey } = await import('@crewm8/core/dist/supermemory/client.js');
    ...
    'supermemory:test-connection': async () => {
      const { testConnection } = await import('@crewm8/core/dist/supermemory/client.js');
    ...
    'inline-task:process': async (_event, args) => {
      return await processCrewInstruction(args.instruction, args.noteContent, args.notePath);
    },
    // Track handlers
