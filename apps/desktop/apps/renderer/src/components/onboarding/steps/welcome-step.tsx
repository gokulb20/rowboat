...
export function WelcomeStep({ state }: WelcomeStepProps) {
  const composioState = state.providerStates['composio'] || { isConnected: false, isLoading: false, isConnecting: false }
      ...
      >
        {composioState.isConnected ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <Button
              onClick={() => {
                state.setOnboardingPath('composio')
          ...
          <div className="flex flex-col items-center gap-4">
            <Button
              onClick={() => {
                state.setOnboardingPath('composio')
                state.startConnect('composio')
              }}
              size="lg"
              className="w-full h-12 text-base font-medium"
              disabled={composioState.isConnecting}
            >
              {composioState.isConnecting ? (
