    ...
    <NodeViewWrapper className="task-block-wrapper" data-type="task-block">
      <div className="task-block-card">
        ...
        <div className="task-block-content">
          <span className="task-block-instruction"><span className="task-block-prefix">@crewm8</span> {instruction}</span>
          {processing && (
    ...
    return [
      {
        ...
        getAttrs(element) {
          ...
          if (cls.includes('language-task') || cls.includes('language-tell-crewm8')) {
