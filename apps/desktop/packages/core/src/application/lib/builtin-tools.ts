...
import { McpServerDefinition } from "@crewm8/shared/dist/mcp.js";
...
import { CURATED_TOOLKITS, CURATED_TOOLKIT_SLUGS } from "@crewm8/shared/dist/composio.js";
import { BrowserControlInputSchema, type BrowserControlInput } from "@crewm8/shared/dist/browser-control.js";
        ...
        execute: async (input: {
            ...
            switch (input.action) {
                ...
                case 'get-base-state': {
                    ...
                    try {
                        const { parseFrontmatter } = await import("@crewm8/shared/dist/frontmatter.js");
