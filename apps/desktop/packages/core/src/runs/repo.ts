...
import { Run, RunEvent, StartEvent, CreateRunOptions, ListRunsResponse, MessageEvent } from "@crewm8/shared/dist/runs.js";
 ...
 * (`@crewm8/shared/dist/runs.js`) — the lenient form just adds one fallback variant.
 */
